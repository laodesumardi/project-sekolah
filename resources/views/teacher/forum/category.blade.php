    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $stats['total_replies'] }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow mb-6">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                    <h2 class="text-lg font-semibold text-gray-900">Diskusi {{ $category->name }}</h2>
                    <div class="flex space-x-3">
                        ...
                        <select class="px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <option>Urutkan: Paling Banyak Balasan</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow">
            ...
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">Jadilah yang pertama membuat diskusi di kategori ini.</p>
                <div class="mt-6">
                    <a href="{{ route('teacher.forum.create') }}" 
                       class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-shrink-0">
                            <div class="flex items-center space-x-2">
                                ...
                                <div class="relative">
                                    <button onclick="toggleDropdown({{ $discussion->id }})" 
                                            class="inline-flex items-center px-3 py-1 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                                        </svg>
                                    </button>
                                    <div id="dropdown-{{ $discussion->id }}" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10">
                                        <div class="py-1">
...
function toggleDropdown(discussionId) {
    const dropdown = document.getElementById(`dropdown-${discussionId}`);
