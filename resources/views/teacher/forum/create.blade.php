...
@section('description', 'Buat diskusi baru di forum guru')
...
<div class="py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h1 class="text-3xl font-bold text-gray-900 mt-2">Buat Diskusi Baru</h1>
                    <p class="mt-2 text-gray-600">Bagikan pengalaman dan diskusikan dengan sesama guru</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow">
            <form id="discussionForm" action="{{ route('teacher.forum.store') }}" method="POST">
                @csrf
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Buat judul yang jelas dan menarik untuk diskusi Anda</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Pilih kelas jika diskusi spesifik untuk kelas tertentu</p>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="content" name="content" rows="8" required 
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" 
                                  placeholder="Tulis isi diskusi Anda di sini..."></textarea>
                        <p class="mt-1 text-sm text-gray-500">Jelaskan topik diskusi dengan detail dan berikan konteks yang jelas</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Tambahkan tag untuk memudahkan pencarian diskusi</p>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('discussionForm').addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                ...
                alert('Gagal membuat diskusi: ' + (data.message || 'Terjadi kesalahan'));
    ...
    function autoSave() {
        ...
        if (title || content) {
            localStorage.setItem('forum_draft_title', title);
            localStorage.setItem('forum_draft_content', content);
        }
    }
    ...
    const savedTitle = localStorage.getItem('forum_draft_title');
    const savedContent = localStorage.getItem('forum_draft_content');
    
    if (savedTitle) titleInput.value = savedTitle;
    if (savedContent) contentInput.value = savedContent;
    
    // Clear draft on successful submit
    document.getElementById('discussionForm').addEventListener('submit', function() {
