    ...
    <div class="mb-6">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Kelola pendaftaran PPDB siswa baru</p>
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $registration->school_origin }}</div>
                            <div class="text-sm text-gray-500">Tahun Lulus: {{ $registration->graduation_year }}</div>
                            @if($registration->photo_3x4 || $registration->birth_certificate)
                            <div class="mt-1">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <p class="text-lg">Belum ada data pendaftar PPDB</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
...
function deleteRegistration(id) {
    if (confirm('Apakah Anda yakin ingin menghapus pendaftaran PPDB ini?')) {
        fetch(`/admin/ppdb-registrations/${id}`, {
            method: 'DELETE',
            headers: {
...
function bulkApprove() {
    ...
    if (confirm(`Apakah Anda yakin ingin menyetujui ${selectedRegistrations.length} pendaftaran PPDB?`)) {
        fetch('/admin/ppdb-registrations/bulk-status', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json',
