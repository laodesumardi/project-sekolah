...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white border-b border-gray-200">
        <div class="px-6 py-4">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-[#13315c]">Tambah Prestasi Baru</h1>
    ...
    <div class="p-6">
        <form id="achievement-form" action="{{ route('admin.achievements.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            @csrf
            ...
            <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="achievement_level" 
                                ...
                                <option value="{{ $key }}" {{ old('achievement_level') == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                                @endforeach
                            </select>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 text-xs text-gray-500">
                            <span id="desc-char-count">0</span>/10000 karakter
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea id="prize" 
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#13315c] focus:border-transparent">{{ old('prize') }}</textarea>
                        </div>
...
function validateForm() {
    ...
    const achievementLevel = document.getElementById('achievement_level');
    ...
    if (!achievementLevel.value) {
        alert('Tingkat prestasi harus dipilih!');
        achievementLevel.focus();
        return false;
    }
    ...
    if (!participantType.value) {
        alert('Jenis peserta harus dipilih!');
        participantType.focus();
        return false;
    }
