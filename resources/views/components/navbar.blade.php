    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="navbar-container">
            ...
            <div class="navbar-menu hidden lg:flex items-center space-x-4">
                ...
                <a href="{{ config('app.url') }}/ppdb" class="navbar-link text-gray-700 hover:text-primary-500 px-4 py-2 text-sm font-medium transition-colors duration-200 {{ request()->routeIs('ppdb*') ? 'text-primary-600 active' : '' }}">
                    PPDB
                </a>
                <div class="relative group">
        ...
        <div class="px-4 py-2">
            ...
            <nav class="space-y-1">
                ...
                <a href="{{ config('app.url') }}/ppdb" class="mobile-menu-item {{ request()->routeIs('ppdb*') ? 'active' : '' }}">
                    <div class="flex items-center space-x-3">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
