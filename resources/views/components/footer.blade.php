            ...
            <div class="space-y-4">
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <p class="text-gray-300 text-sm">Jl. Pendidikan No. 123</p>
                            <p class="text-gray-300 text-sm">Namrole, Maluku</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-3">
                        ...
                        <p class="text-gray-300 text-sm">(0910) 123456</p>
                    </div>
                    <div class="flex items-center space-x-3">
                        <svg class="h-5 w-5 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                        <p class="text-gray-300 text-sm">info@smpn01namrole.sch.id</p>
                    </div>
                </div>
            </div>
        </div>
