        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-xl font-bold">SMP Negeri 01 Namrole</h3>
                        <p class="text-sm text-gray-300">Sekolah Menengah Pertama</p>
                    </div>
                </div>
                <p class="text-gray-300 text-sm leading-relaxed">
                    SMP Negeri 01 Namrole adalah sekolah menengah pertama yang berkomitmen untuk memberikan pendidikan berkualitas tinggi dan membentuk karakter siswa yang unggul.
                </p>
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-3">
                        <svg class="h-5 w-5 text-primary-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
                        <div>
                            <p class="text-gray-300 text-sm">{{ $homepageSetting->contact_address ?? 'Jl. Pendidikan No. 123, Namrole, Maluku' }}</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-3">
                        ...
                        <p class="text-gray-300 text-sm">{{ $homepageSetting->contact_phone ?? '(0910) 123456' }}</p>
                    </div>
                    <div class="flex items-center space-x-3">
                        <svg class="h-5 w-5 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                        <p class="text-gray-300 text-sm">{{ $homepageSetting->contact_email ?? 'info@smpn01namrole.sch.id' }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="border-t border-gray-700 mt-8 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-300 text-sm">
                    © {{ date('Y') }} SMP Negeri 01 Namrole. All rights reserved.
                </p>
                <div class="flex space-x-6 mt-4 md:mt-0">
                    <a href="#" class="text-gray-300 hover:text-white text-sm transition-colors duration-200">Privacy Policy</a>
                    <a href="#" class="text-gray-300 hover:text-white text-sm transition-colors duration-200">Terms of Service</a>
                </div>
            </div>
        </div>
    </div>
